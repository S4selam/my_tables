...
SELECT *
FROM employees
WHERE frist_name = 'Killie' or first_name = 'Aruna'
...
SELECT *
FROM employees 
WHERE first_name IN ('Cathie', 'Mark' or 'Nathan')

-- NOT IN
SELECT *
FROM employees 
WHERE first_name NOT IN ('Cathie', 'Mark' or 'Nathan')
